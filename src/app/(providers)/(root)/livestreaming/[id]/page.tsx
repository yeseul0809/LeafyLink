...
export default async function StreamingPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="pt-[80px] pb-[180px] max_sm:pt-[12px] max_sm:pb-[188px] px-[20px]">
      ...
      <div className="flex justify-between mt-[32px] max_sm:mt-[20px] max_sm:flex-col w-full items-start max_lg:flex-col">
        <div className="flex gap-[32px] justify-between items-start w-[88%] xs_max:w-full">
          <div className="flex flex-col gap-[8px]">
            <div className="flex flex-col gap-[16px] mb-[20px] xs:mb-[16px]">
