...
//   const handleNext = () => {
//     setStartPage((prev) => {
//       const newStartPage = prev + pageCount;
//       const remainingPages = totalPages - newStartPage + 1;
//       if (remainingPages < pageCount) {
//         return totalPages - remainingPages + 1;
//       }
//       return newStartPage;
//     });
//   };
...
//                 <div
//                   className={`w-6 h-6 flex items-center justify-center rounded-full border ${currentPage === pageNum ? 'bg-teal-700 text-white font-bold' : 'border-transparent hover:border-gray-400'}`}
//                 >
//                   {pageNum}
//                 </div>
//               </Link>
