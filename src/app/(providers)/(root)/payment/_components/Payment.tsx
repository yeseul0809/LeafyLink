...
//     isFormAlldone && setIsOrderAble((prev) => !prev);
//   };
...
//     setIsAgreementChecked(event.target.checked); // 추가된 부분
//   };

//   useEffect(() => {
//     // Update button enabled/disabled state based on agreement and form completion
//     setIsOrderAble(isFormAlldone && isAgreementChecked); // 수정된 부분
//   }, [isFormAlldone, isAgreementChecked]); // 수정된 부분
