...
function EventCard() {
  ...
  return (
    <div className="w-[400px] text-center">
      <div className="w-full h-[300px] border-[1px] relative p-4 rounded-[20px] mb-5">
        {eventType === 'gift' ? (
      ...
      <p className="w-full text-[20px] font-semibold truncate mb-1">이벤트 타이틀</p>
      <p className="truncate text-font/sub1 text-[15px] mb-3">
